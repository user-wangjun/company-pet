...
def main() -> None:
    ...
    draw.text((48, 25), "小橘 X6：头底隐藏补全复审 v12", font=font(39, True), fill="#18344f")
    draw.text(
        (50, 80),
        "同一份 v11 自然毛流头底重新排版放大；本图不传播到身体、四肢、侧背或 X7。",
        font=font(20),
        fill="#586a78",
    )
    ...
    preview_path = QA / "x6-head-hidden-texture-review-v12.png"
    ...
    contract = {
        ...
        "preview": "live2d/x6/qa/x6-head-hidden-texture-review-v12.png",
        "reviewFocus": ["eye-socket-hidden-fur", "mouth-hidden-fur", "ear-root-hidden-fur", "rest-reconstruction"],
        "gateBoundary": v11["gateBoundary"],
    }
    (X6 / "x6-head-hidden-texture-review-contract-v12.json").write_text(
