...
var output = new File(root.fsName + "/xiaoju-planet-login-live2d-source.psd");
...
var document = app.documents.add(1370, 1148, 72, "xiaoju-planet-login-live2d-source", NewDocumentMode.RGB, DocumentFill.TRANSPARENT);
